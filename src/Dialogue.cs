...
public static class Dialogue {
    ...
    public static Dictionary<PlayerTypes, String> greetingsDict = new Dictionary<PlayerTypes, String>{ 
        ...
        [new PlayerTypes(Personality.Cheapskate, SpecialTrait.Dungeoneer)] = "Salutations. I’m looking for cursed items that fit into my budget. I’m running a bit low on funds.",
    };
